...
<%-- /jsp2/src/main/webapp/model1/member/list.jsp 
	...
	2. 일반사용자로 로그인 상태 : 관리지만 가능한 거래입니다. 메세지 출력. main.jsp로 페이지 이동
	3. db에서 모든 회원정보를 조회해서 화면에 출력하기
...
<% } else { //3. db에서 모든 회원정보를 조회해서 화면에 출력하기
	//list : db member 테이블의 모든 정보를 저장하고 있는 목록
