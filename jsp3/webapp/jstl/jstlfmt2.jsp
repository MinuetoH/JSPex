...
<body>
<h3>Format 된 숫자를 일반적인 숫자로 변경</h3>
...
<fmt:parseNumber value="${num1 }" pattern="##,###" /> +
<fmt:parseNumber value="${num2 }" pattern="##,###" /> =
<fmt:parseNumber value="${num1+num2 }" pattern="##,###" /><br>

<fmt:parseNumber value="${num1 }" pattern="##,###" var="snum1" />
<fmt:parseNumber value="${num2 }" pattern="##,###" var="snum2" />
<fmt:parseNumber value="${num1+num2 }" pattern="##,###" var="snum3" />
