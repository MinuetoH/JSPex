...
substring(str1,3,6)=${fn:substring(str1,3,6)}:str1 문자열에서 3번 인덱스부터 5번 인덱스까지 리턴<br>
substringAfter(str1,str2)=${fn:substringAfter(str1,str2)}:str1에서 str2이후 부분<br>
substringBefore(str1,str2)=${fn:substringBefore(str1,str2)}:str1에서 str2이전 부분<br>
contains(str1,str2)=${fn:contains(str1,str2)}:str1 내부에 str2 존재?<br>
trim(str1)=${fn:trim(str1)}:str1에서 공백 제거.<br>
replace(str1," ","-")=${fn:replace(str1," ","-")}:str1에서 공백을 -으로 변경<br>
split(tokens,',') : tokens 값을 ,를 기준으로 분리해서 배열로 리턴<br>
